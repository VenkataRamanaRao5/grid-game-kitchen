...
function $s_Lgridgamekitchen_HelloWorld__main__AT__V(args) {
  $m_Lgridgamekitchen_HelloWorld$().main__AT__V(args);
}
/** @constructor */
function $c_Lgridgamekitchen_HelloWorld$() {
}
$c_Lgridgamekitchen_HelloWorld$.prototype = new $h_O();
$c_Lgridgamekitchen_HelloWorld$.prototype.constructor = $c_Lgridgamekitchen_HelloWorld$;
/** @constructor */
function $h_Lgridgamekitchen_HelloWorld$() {
}
$h_Lgridgamekitchen_HelloWorld$.prototype = $c_Lgridgamekitchen_HelloWorld$.prototype;
$c_Lgridgamekitchen_HelloWorld$.prototype.main__AT__V = (function(args) {
  document.addEventListener("DOMContentLoaded", ((e) => {
    $m_Lgridgamekitchen_HelloWorld$package$().setupUI__V();
  }));
});
var $d_Lgridgamekitchen_HelloWorld$ = new $TypeData().initClass($c_Lgridgamekitchen_HelloWorld$, "gridgamekitchen.HelloWorld$", ({
  Lgridgamekitchen_HelloWorld$: 1
}));
var $n_Lgridgamekitchen_HelloWorld$;
function $m_Lgridgamekitchen_HelloWorld$() {
  if ((!$n_Lgridgamekitchen_HelloWorld$)) {
    $n_Lgridgamekitchen_HelloWorld$ = new $c_Lgridgamekitchen_HelloWorld$();
  }
  return $n_Lgridgamekitchen_HelloWorld$;
}
/** @constructor */
function $c_Lgridgamekitchen_HelloWorld$package$() {
}
$c_Lgridgamekitchen_HelloWorld$package$.prototype = new $h_O();
$c_Lgridgamekitchen_HelloWorld$package$.prototype.constructor = $c_Lgridgamekitchen_HelloWorld$package$;
/** @constructor */
function $h_Lgridgamekitchen_HelloWorld$package$() {
}
$h_Lgridgamekitchen_HelloWorld$package$.prototype = $c_Lgridgamekitchen_HelloWorld$package$.prototype;
$c_Lgridgamekitchen_HelloWorld$package$.prototype.appendPar__Lorg_scalajs_dom_Node__T__V = (function(targetNode, text) {
  var parNode = document.createElement("p");
  parNode.textContent = text;
  targetNode.appendChild(parNode);
});
$c_Lgridgamekitchen_HelloWorld$package$.prototype.addClickedMessage__V = (function() {
  $m_Lgridgamekitchen_HelloWorld$package$().appendPar__Lorg_scalajs_dom_Node__T__V(document.body, "You clicked the button!");
});
$c_Lgridgamekitchen_HelloWorld$package$.prototype.setupUI__V = (function() {
  var button = document.createElement("button");
  button.textContent = "Click me!";
  button.addEventListener("click", ((e) => {
    $m_Lgridgamekitchen_HelloWorld$package$().addClickedMessage__V();
  }));
  document.body.appendChild(button);
  $m_Lgridgamekitchen_HelloWorld$package$().appendPar__Lorg_scalajs_dom_Node__T__V(document.body, "Hello World");
});
var $d_Lgridgamekitchen_HelloWorld$package$ = new $TypeData().initClass($c_Lgridgamekitchen_HelloWorld$package$, "gridgamekitchen.HelloWorld$package$", ({
  Lgridgamekitchen_HelloWorld$package$: 1
}));
var $n_Lgridgamekitchen_HelloWorld$package$;
function $m_Lgridgamekitchen_HelloWorld$package$() {
  if ((!$n_Lgridgamekitchen_HelloWorld$package$)) {
    $n_Lgridgamekitchen_HelloWorld$package$ = new $c_Lgridgamekitchen_HelloWorld$package$();
  }
  return $n_Lgridgamekitchen_HelloWorld$package$;
}
/** @constructor */
...
$s_Lgridgamekitchen_HelloWorld__main__AT__V(new ($d_T.getArrayOf().constr)([]));
}).call(this);
